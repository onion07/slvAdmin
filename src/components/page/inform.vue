<template>
    <div class="table">
        ...
        <el-table v-loading.body="loading" :data="tableData" border stripe style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="uid" label="举报者UID" width="160">
            </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getData(){
                ...
                const ot_value = _ts.sle_value2.match(/\d/) == null ? 3 : _ts.sle_value2; //默认加载 3:‘随机视频用户’
                // const start_value = _ts.value1 === '' ? _ts.theDay(true) : _ts.value1;
                // const end_value = _ts.value2 === '' ? _ts.theDay(true) : _ts.value2;

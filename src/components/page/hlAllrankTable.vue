    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>总榜</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            getData(){
                ...
                _ts.url = '/h5/v1/facedance/leaderboard/universal';
                if(process.env.NODE_ENV === 'development'){
                    _ts.url = 'http://test.hongdoulive.com/h5/v1/facedance/leaderboard/universal';
                };

                getAxiosHlrankData(_ts.url,{pageNo:_ts.cur_page,pageSize:20,},function (retData,pgTotal) {
